...
const createChart = (chartRef, formData) => {
  console.log("Chart Code Raw test data");
  ...
  new BarChart(
    ...
    },
    {
      ...
      stackBars: formData.stackBars ? formData.stackBars : false,
      ...
      plugins: [
        ChartistTooltip({
          appendToBody: true,
          transformTooltipTextFnc: (value) => `${value}% CAGR`,
        }),
        /*
        ChartistTooltip({
          appendToBody: true,
...
const testData_old = {
  ...
  series: [
    { name: "Group 1", data: [20, 10, 30, 20, 10] },
    { name: "Group 2", data: [40, 30, 30, 10, 70] },
  ],
  offset_axisx: 30,
  position_axisx: "end",
...
export { createChart, testData };

// accomulate overlap silhouette expand
